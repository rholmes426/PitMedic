...
<head>
  ...
  <title>PitMedic App Usage Analytics</title>
  <style>${dashboardStyles}</style>
</head>
<body>
  <header>
    <a class="brand" href="/dashboard"><strong>PIT</strong><em>MEDIC</em><span>ANALYTICS</span></a>
    <nav class="dashboard-nav" aria-label="Dashboard tabs"><a href="/dashboard">Overview</a><a class="active" aria-current="page" href="/app">App usage</a><a href="/website">Website &amp; search</a></nav>
    <div class="header-actions"><span class="private-pill">PRIVATE</span><a class="refresh" href="/app">Refresh</a><form method="post" action="/logout"><button class="logout" type="submit">Log out</button></form></div>
  </header>
  <main>
    <section class="intro">
...
function metricCard(
  ...
  return `<article class="metric"><span>${escapeHtml(label)}</span><strong>${escapeHtml(displayValue)}</strong><small>${escapeHtml(description)}</small></article>`;
}
...
a.metric-link{color:inherit;text-decoration:underline;text-decoration-color:#ee7739;text-underline-offset:4px}a.metric-link:hover{color:#d75715}a.metric-link:focus-visible{outline:3px solid #e96c26;outline-offset:4px}
...
.overview-grid{display:grid;grid-template-columns:1fr 1fr;gap:14px}.overview-card{min-height:235px}.overview-card .panel-head{align-items:center}.panel-link{color:var(--navy2);font-size:12px;font-weight:800;text-decoration:none}.panel-link:hover{text-decoration:underline}.overview-stats{display:grid;grid-template-columns:repeat(3,1fr);gap:9px;margin-bottom:17px}.overview-stats>div{background:var(--soft);border-radius:9px;padding:13px}.overview-stats span,.overview-stats strong{display:block}.overview-stats span{min-height:28px;color:var(--muted);font-size:10px;font-weight:800;text-transform:uppercase;letter-spacing:.4px}.overview-stats strong{color:var(--navy);font-size:24px;margin-top:5px}.overview-card p{color:var(--muted);font-size:13px;line-height:1.5;margin:0}
...
@media(max-width:820px){header{height:auto;min-height:72px;flex-wrap:wrap;padding-top:12px;padding-bottom:12px}.dashboard-nav{order:3;width:100%;margin:0}.cards{grid-template-columns:repeat(2,1fr)}.grid,.overview-grid,.web-grid.two,.web-grid.three,.search-grid{grid-template-columns:1fr}.search-metrics{grid-template-columns:1fr 1fr}.web-grid.three .panel:first-child{grid-column:auto}.intro{align-items:flex-start;flex-direction:column}.timestamp{white-space:normal}.journeys{grid-template-columns:1fr}.trend-day>span{display:none}}
...
@media(max-width:1050px){.cards.five{grid-template-columns:repeat(3,1fr)}}
@media(max-width:820px){.cards.five{grid-template-columns:repeat(2,1fr)}}
`;
