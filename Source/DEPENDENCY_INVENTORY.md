...
This inventory records the packages resolved by the v0.6.0.0 .NET 10 projects. It is a release-preparation aid and does not replace the license text or notices supplied by each project.
