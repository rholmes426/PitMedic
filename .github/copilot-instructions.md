# Copilot instructions for PitMedic
...
project policy. Do not add data collection, diagnostics uploads, advertising, payment
handling, credentials, or silent updates. Keep generated Diagnostic Library output in sync
with the app knowledge base.

Before proposing a release, inspect `PENDING-UPDATES.md`, `PENDING_FIXES.md`, open PRs,
and recent workflow results. Run the smallest relevant tests, plus full Build Validation
when app, Build, workflow, or unknown files are touched.
